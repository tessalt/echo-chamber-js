...
},{"./src/echo_chamber.jsx":158}],2:[function(require,module,exports){
/**
...
var App = {
  ...
  init: function () {
    ...
    React.render(React.createElement(Frame, null), div);
  }
}
...
var Frame = React.createClass({displayName: "Frame",
  ...
  componentDidMount: function() {
    ...
    img.onerror = function() {
      ...
      React.render(React.createElement(CommentBox, {path: window.location.href, onResize: this.onResize}), this.getDOMNode().contentDocument.body);
    }.bind(this);
  },
  ...
  render: function () {
    ...
    return (
      React.createElement("iframe", {height: this.state.height, style: styles, scrolling: "false", horizontalscrolling: "no", verticalscrolling: "no"})
    )
  }
});
  ...
  render: function () {
    ...
    return (
      React.createElement("div", null, 
        React.createElement("h1", null, length, " ", commentsWord), 
...
var Comment = React.createClass({displayName: "Comment",
  render: function () {
    return (
      React.createElement("div", null, 
        React.createElement("h3", null, this.props.data.author.name), 
        React.createElement("p", null, this.props.data.author.email), 
  ...
  render: function () {
    return (
      React.createElement("form", {onSubmit: this.handleSubmit}, 
        ...
        React.createElement("input", {type: "email", placeholder: "Your email", ref: "email"}), 
        React.createElement("textarea", {placeholder: "Say something...", ref: "text"}), 
