var count = (function minus(Big) {
    ...
    function T(minuend, subtrahend, expected) {
        assert(String(expected), String(new Big(minuend).minus(subtrahend)));
        assert(String(expected), String(new Big(minuend).minus(new Big(subtrahend))));
    }
    ...
    assert(false, isMinusZero(new Big(0).minus(0)));
    assert(false, isMinusZero(new Big(0).minus(-0)));
    assert(true, isMinusZero(new Big(-0).minus(0)));
    assert(false, isMinusZero(new Big(-0).minus(-0)));
    assert(false, isMinusZero(new Big(1).minus(1)));
    assert(false, isMinusZero(new Big(-1).minus(-1)));
    ...
    assertException(function () {new Big('12.345').minus(undefined)}, ".minus(undefined)");
    assertException(function () {new Big('12.345').minus(null)}, ".minus(null)");
    assertException(function () {new Big('12.345').minus(NaN)}, ".minus(NaN)");
    assertException(function () {new Big('12.345').minus('NaN')}, ".minus('NaN')");
    assertException(function () {new Big('12.345').minus([])}, ".minus([])");
    assertException(function () {new Big('12.345').minus({})}, ".minus({})");
    assertException(function () {new Big('12.345').minus('')}, ".minus('')");
    assertException(function () {Big('12.345').minus(' ')}, ".minus(' ')");
    assertException(function () {new Big('12.345').minus('hello')}, ".minus('hello')");
    assertException(function () {new Big('12.345').minus('\t')}, ".minus('\t')");
    assertException(function () {new Big('12.345').minus(new Date)}, ".minus(new Date)");
    assertException(function () {new Big('12.345').minus(new RegExp)}, ".minus(new RegExp)");
    assertException(function () {new Big('12.345').minus(function () {})}, ".minus(function () {})");
    assertException(function () {new Big('12.345').minus(' 0.1')}, ".minus(' 0.1')");
    assertException(function () {new Big('12.345').minus('7.5 ')}, ".minus('7.5 ')");
    assertException(function () {Big('12.345').minus(' 0 ')}, ".minus(' 0 ')");
    assertException(function () {new Big('12.345').minus('+1')}, ".minus('+1')");
    assertException(function () {new Big('12.345').minus(' +1.2')}, ".minus(' +1.2')");
    ...
    assertException(function () {new Big('12.345').minus('4e1.')}, ".minus('4e1.')");
    assertException(function () {Big('12.345').minus(Infinity)}, ".minus(Infinity)");
    assertException(function () {new Big('12.345').minus('-Infinity')}, ".minus('-Infinity')");
