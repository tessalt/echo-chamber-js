var count = (function plus(Big) {
    ...
    function T(addendA, addendB, expected) {
        assert(String(expected), String(new Big(addendA).plus(addendB)));
        assert(String(expected), String(new Big(addendA).plus(new Big(addendB))));
    }
    ...
    assertException(function () {new Big('12.345').plus(undefined)}, ".plus(undefined)");
    assertException(function () {new Big('12.345').plus(null)}, ".plus(null)");
    assertException(function () {new Big('12.345').plus(NaN)}, ".plus(NaN)");
    assertException(function () {new Big('12.345').plus('NaN')}, ".plus('NaN')");
    assertException(function () {new Big('12.345').plus([])}, ".plus([])");
    assertException(function () {new Big('12.345').plus({})}, ".plus({})");
    assertException(function () {new Big('12.345').plus('')}, ".plus('')");
    assertException(function () {Big('12.345').plus(' ')}, ".plus(' ')");
    assertException(function () {new Big('12.345').plus('hello')}, ".plus('hello')");
    assertException(function () {new Big('12.345').plus('\t')}, ".plus('\t')");
    assertException(function () {new Big('12.345').plus(new Date)}, ".plus(new Date)");
    assertException(function () {new Big('12.345').plus(new RegExp)}, ".plus(new RegExp)");
    assertException(function () {new Big('12.345').plus(function () {})}, ".plus(function () {})");
    assertException(function () {new Big('12.345').plus(' 0.1')}, ".plus(' 0.1')");
    assertException(function () {new Big('12.345').plus('7.5 ')}, ".plus('7.5 ')");
    assertException(function () {Big('12.345').plus(' 0 ')}, ".plus(' 0 ')");
    assertException(function () {new Big('12.345').plus('+1')}, ".plus('+1')");
    assertException(function () {new Big('12.345').plus(' +1.2')}, ".plus(' +1.2')");
    ...
    assertException(function () {new Big('12.345').plus('4e1.')}, ".plus('4e1.')");
    assertException(function () {Big('12.345').plus(Infinity)}, ".plus(Infinity)");
    assertException(function () {new Big('12.345').plus('-Infinity')}, ".plus('-Infinity')");
