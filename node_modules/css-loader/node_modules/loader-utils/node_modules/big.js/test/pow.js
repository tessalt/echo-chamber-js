var count = (function pow(Big) {
    ...
    function T(expected, n, exp) {
        assert(String(expected), String(new Big(n).pow(exp)))
    }
    ...
    assertException(function () {new Big(9).pow(undefined)}, ".pow(undefined)");
    assertException(function () {new Big(9).pow(null)}, ".pow(null)");
    assertException(function () {new Big(9).pow(NaN)}, ".pow(NaN)");
    assertException(function () {new Big(9).pow('NaN')}, ".pow('NaN')");
    assertException(function () {new Big(9).pow([])}, ".pow([])");
    assertException(function () {new Big(9).pow({})}, ".pow({})");
    assertException(function () {new Big(9).pow('')}, ".pow('')");
    assertException(function () {Big(9).pow(' ')}, ".pow(' ')");
    assertException(function () {new Big(9).pow('hello')}, ".pow('hello')");
    assertException(function () {new Big(9).pow('\t')}, ".pow('\t')");
    assertException(function () {new Big(9).pow(new Date)}, ".pow(new Date)");
    assertException(function () {new Big(9).pow(new RegExp)}, ".pow(new RegExp)");
    assertException(function () {new Big(9).pow(function () {})}, ".pow(function () {})");
    assertException(function () {new Big(9).pow(-23.000001)}, ".pow(-23.000001)");
    assertException(function () {new Big(9).pow(MAX_POWER + 0.02)}, ".pow(MAX_POWER + 0.02)");
    assertException(function () {new Big(9).pow(MAX_POWER + 1)}, ".pow(MAX_POWER + 1)");
    assertException(function () {new Big(9).pow(-MAX_POWER - 0.3)}, ".pow(-MAX_POWER - 0.3)");
    assertException(function () {new Big(9).pow(-MAX_POWER - 1)}, ".pow(-MAX_POWER - 1)");
    assertException(function () {new Big(9).pow(' 0.1')}, ".pow(' 0.1')");
    assertException(function () {new Big(9).pow('7.5 ')}, ".pow('7.5 ')");
    assertException(function () {Big(9).pow(' 0 ')}, ".pow(' 0 ')");
    assertException(function () {new Big(9).pow('+1')}, ".pow('+1')");
    assertException(function () {new Big(9).pow(' +1.2')}, ".pow(' +1.2')");
    assertException(function () {new Big(9).pow('- 99')}, ".pow('- 99')");
    assertException(function () {new Big(9).pow('9.9.9')}, ".pow('9.9.9')");
    assertException(function () {new Big(9).pow('10.1.0')}, ".pow('10.1.0')");
    assertException(function () {new Big(9).pow('234.')}, ".pow('234.')");
    assertException(function () {new Big(9).pow('.5')}, ".pow('.5')");
    assertException(function () {new Big(9).pow('0x16')}, ".pow('0x16')");
    assertException(function () {new Big(9).pow('1e')}, ".pow('1e')");
    assertException(function () {new Big(9).pow('8 e')}, ".pow('8 e')");
    assertException(function () {new Big(9).pow('77-e')}, ".pow('77-e')");
    assertException(function () {new Big(9).pow('123e.0')}, ".pow('123e.0')");
    assertException(function () {new Big(9).pow('4e1.')}, ".pow('4e1.')");
    assertException(function () {Big(9).pow(Infinity)}, ".pow(Infinity)");
    assertException(function () {new Big(9).pow('-Infinity')}, ".pow('-Infinity')");
