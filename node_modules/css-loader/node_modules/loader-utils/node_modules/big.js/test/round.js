var count = (function round(Big) {
    ...
    function T(expected, value, decimalPlaces, roundingMode) {
        assert(String(expected), new Big(String(value)).round(decimalPlaces, roundingMode).toString());
    }
    ...
    assertException(function () {new Big('12.345').round('')}, ".round('')");
    assertException(function () {new Big('12.345').round(' ')}, ".round(' ')");
    assertException(function () {new Big('12.345').round('hello')}, ".round('hello')");
    assertException(function () {new Big('12.345').round('\t')}, ".round('\t')");
    assertException(function () {new Big('12.345').round(new Date)}, ".round(new Date)");
    assertException(function () {new Big('12.345').round(new RegExp)}, ".round(new RegExp)");
    assertException(function () {new Big('12.345').round(function () {})}, ".round(function () {})");
    assertException(function () {new Big('12.345').round(0.1)}, ".round(0.1)");
    assertException(function () {new Big('12.345').round(7.5)}, ".round(7.5)");
    assertException(function () {new Big('12.345').round('0')}, ".round('0')");
    assertException(function () {new Big('12.345').round('1')}, ".round('1')");
    assertException(function () {new Big('12.345').round('1.2')}, ".round('1.2')");
    ...
    assertException(function () {new Big('12.345').round('-1e-1')}, ".round('-1e-1')");
    ...
    assertException(function () {new Big('12.345').round(u, '')}, ".round(u, '')");
    assertException(function () {new Big('12.345').round(u, ' ')}, ".round(u, ' ')");
    assertException(function () {new Big('12.345').round(u, 'hello')}, ".round(u, 'hello')");
    assertException(function () {new Big('12.345').round(u, '\t')}, ".round(u, '\t')");
    assertException(function () {new Big('12.345').round(u, new Date)}, ".round(u, new Date)");
    assertException(function () {new Big('12.345').round(u, function () {})}, ".round(u, function () {})");
    assertException(function () {new Big('12.345').round(u, new RegExp)}, ".round(u, new RegExp)");
    assertException(function () {new Big('12.345').round(u, 0.1)}, ".round(u, 0.1)");
    assertException(function () {new Big('12.345').round(u, 7.5)}, ".round(u, 7.5)");
    assertException(function () {new Big('12.345').round(u, '0')}, ".round(u, '0')");
    assertException(function () {new Big('12.345').round(u, '1')}, ".round(u, '1')");
    assertException(function () {new Big('12.345').round(u, '1.2')}, ".round(u, '1.2')");
    ...
    assertException(function () {new Big('12.345').round(u, -1)}, ".round(u, -1)");
    assertException(function () {new Big('12.345').round(u, '-0.01')}, ".round(u, '-0.01')");
    assertException(function () {new Big('12.345').round(u, '-1e-1')}, ".round(u, '-1e-1')");
    assertException(function () {new Big('12.345').round(u, Infinity)}, ".round(u, Infinity)");
    assertException(function () {new Big('12.345').round(u, '-Infinity')}, ".round(u, '-Infinity')");
    assertException(function () {new Big('12.345').round(u, new Big('2'))}, ".round(u, new Big('2'))");
