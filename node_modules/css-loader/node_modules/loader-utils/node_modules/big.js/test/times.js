var count = (function times(Big) {
    ...
    function T(multiplicand, multiplier, expected) {
        assert(String(expected), String(new Big(multiplicand).times(multiplier)));
        assert(String(expected), String(new Big(multiplicand).times(new Big(multiplier))));
    }
    ...
    assert(false, isMinusZero(new Big(1).times(0)));
    assert(true, isMinusZero(new Big(1).times(-0)));
    assert(true, isMinusZero(new Big(-1).times(0)));
    assert(false, isMinusZero(new Big(-1).times(-0)));
    assert(false, isMinusZero(new Big(0).times(1)));
    assert(true, isMinusZero(new Big(0).times(-1)));
    assert(true, isMinusZero(new Big(-0).times(1)));
    assert(false, isMinusZero(new Big(-0).times(-1)));
    assert(false, isMinusZero(new Big(0).times(0)));
    assert(true, isMinusZero(new Big(0).times(-0)));
    assert(true, isMinusZero(new Big(-0).times(0)));
    assert(false, isMinusZero(new Big(-0).times(-0)));
    ...
    assertException(function () {new Big('1').times(undefined)}, ".times(undefined)");
    assertException(function () {new Big('1').times(null)}, ".times(null)");
    assertException(function () {new Big('1').times(NaN)}, ".times(NaN)");
    assertException(function () {new Big('1').times('NaN')}, ".times('NaN')");
    assertException(function () {new Big('1').times([])}, ".times([])");
    assertException(function () {new Big('1').times({})}, ".times({})");
    assertException(function () {new Big('1').times('')}, ".times('')");
    assertException(function () {Big('1').times(' ')}, ".times(' ')");
    assertException(function () {new Big('1').times('hello')}, ".times('hello')");
    assertException(function () {new Big('1').times('\t')}, ".times('\t')");
    assertException(function () {new Big('1').times(new Date)}, ".times(new Date)");
    assertException(function () {new Big('1').times(new RegExp)}, ".times(new RegExp)");
    assertException(function () {new Big('1').times(function () {})}, ".times(function () {})");
    assertException(function () {new Big('1').times(' 0.1')}, ".times(' 0.1')");
    assertException(function () {new Big('1').times('7.5 ')}, ".times('7.5 ')");
    assertException(function () {Big('1').times(' 0 ')}, ".times(' 0 ')");
    assertException(function () {new Big('1').times('+1')}, ".times('+1')");
    assertException(function () {new Big('1').times(' +1.2')}, ".times(' +1.2')");
    ...
    assertException(function () {new Big('1').times('4e1.')}, ".times('4e1.')");
    assertException(function () {Big('1').times(Infinity)}, ".times(Infinity)");
    assertException(function () {new Big('1').times('-Infinity')}, ".times('-Infinity')");
