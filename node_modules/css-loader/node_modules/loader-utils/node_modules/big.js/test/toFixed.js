var count = (function toFixed(Big) {
    var start = +new Date(),
        log,
        error,
        u,
    ...
    function T(expected, value, decimalPlaces){
        assert(String(expected), new Big(value).toFixed(decimalPlaces));
    }
    ...
    '0460440794925193040344223656739741115687100160257607638', new Big('-1478635511205065720411441088234634087783' +
    ...
    assertException(function () {new Big(1.23).toFixed('')}, "''");
    assertException(function () {new Big(1.23).toFixed(' ')}, "' '");
    assertException(function () {new Big(1.23).toFixed('hello')}, "'hello'");
    assertException(function () {new Big(1.23).toFixed('\t')}, "'\t'");
    assertException(function () {new Big(1.23).toFixed(new Date)}, "new Date");
    assertException(function () {new Big(1.23).toFixed(new RegExp)}, "new RegExp");
    assertException(function () {new Big(1.23).toFixed(2.01)}, "2.01");
    assertException(function () {new Big(1.23).toFixed(10.5)}, "10.5");
    assertException(function () {new Big(1.23).toFixed('1.1e1')}, "'1.1e1'");
    assertException(function () {new Big(1.23).toFixed(true)}, "true");
    assertException(function () {new Big(1.23).toFixed(false)}, "false");
    assertException(function () {new Big(1.23).toFixed(function (){})}, "function (){}");
    assertException(function () {new Big(1.23).toFixed(Big('3'))}, "Big('3')");
    assertException(function () {new Big(1.23).toFixed('0')}, "'0'");
    assertException(function () {new Big(1.23).toFixed('1')}, "'1'");
    assertException(function () {new Big(1.23).toFixed('22')}, "'22'");
    assertException(function () {new Big(1.23).toFixed('-0.00')}, "'-0.00'");
    assertException(function () {new Big(1.23).toFixed('-1')}, "'-1'");
    assertException(function () {new Big(1.23).toFixed(-23)}, "-23");
    assertException(function () {new Big(1.23).toFixed(1e9 + 1)}, "1e9 + 1");
    assertException(function () {new Big(1.23).toFixed(1e9 + 0.1)}, "1e9 + 1");
    assertException(function () {new Big(1.23).toFixed('-0.01')}, "'-0.01'");
    assertException(function () {new Big(1.23).toFixed('-1e-1')}, "'-1e-1'");
    assertException(function () {new Big(1.23).toFixed(Infinity)}, "Infinity");
    assertException(function () {new Big(1.23).toFixed('-Infinity')}, "'-Infinity'");
    ...
    T('0.2', '0.101', 1);
    T('-0.2', '-0.101', 1);
    T('0.10001', '0.100000000000000000000001', 5);
    T('-0.10001', '-0.100000000000000000000001', 5);
    T('1.24', '1.234', 2);
    T('-1.24', '-1.234', 2);
    T('98765.43210', '98765.4321', 5);
    T('-98765.43210', '-98765.4321', 5);
    T('1000.000', '999.9999', 3);
    T('-1000.000', '-999.9999', 3);
