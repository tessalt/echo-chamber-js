var count = (function mod(Big) {
    ...
    function T(a, b, expected) {
        assert(String(expected), String(new Big(a).mod(new Big(b))));
    }
    ...
    assert(false, isMinusZero(new Big(0).mod(1)));
    assert(false, isMinusZero(new Big(0).mod(-1)));
    assert(true, isMinusZero(new Big(-0).mod(1)));
    assert(true, isMinusZero(new Big(-0).mod(-1)));
    assert(false, isMinusZero(new Big(1).mod(1)));
    T(1, '-45', '1');
    T(1, '22', '1');
    T(1, 0144, '1');
    T(1, '0144', '1');
    ...
    T(-999.99, '3.01', '-0.67');
    T(1, '0.09', '0.01');
    assert(false, isMinusZero(new Big(1).mod('-0.0001')));
    assert(true, isMinusZero(new Big(-0).mod(1)));
    assert(true, isMinusZero(new Big(-0).mod(0.1)));
    assert(true, isMinusZero(new Big('-0').mod('-1')));
    T(1, '8e5', '1');
    T(1, '9E12', '1');
    assert(false, isMinusZero(new Big(1).mod('1e-14')));
    T(1, '-345.43e+4', '1');
    T(1, '-94.12E+0', '1');
    T(0, '0.001', '0');
    T(0, '-0.001', '0');
    ...
    assertException(function () {new Big(0).mod(0)}, ".mod(0)");
    assertException(function () {new Big('-1').mod(0)}, ".mod(0)");
    assertException(function () {new Big(9).mod(0)}, ".mod(0)");
    assertException(function () {new Big(9).mod('0')}, ".mod('0')");
    assertException(function () {new Big(9).mod('-0')}, ".mod('-0')");
    assertException(function () {new Big(9).mod('0.00')}, ".mod('0.00')");

    assertException(function () {new Big('12.345').mod(undefined)}, ".mod(undefined)");
    assertException(function () {new Big('12.345').mod(null)}, ".mod(null)");
    assertException(function () {new Big('12.345').mod(NaN)}, ".mod(NaN)");
    assertException(function () {new Big('12.345').mod('NaN')}, ".mod('NaN')");
    assertException(function () {new Big('12.345').mod([])}, ".mod([])");
    assertException(function () {new Big('12.345').mod({})}, ".mod({})");
    assertException(function () {new Big('12.345').mod('')}, ".mod('')");
    assertException(function () {Big('12.345').mod(' ')}, ".mod(' ')");
    assertException(function () {new Big('12.345').mod('hello')}, ".mod('hello')");
    assertException(function () {new Big('12.345').mod('\t')}, ".mod('\t')");
    assertException(function () {new Big('12.345').mod(new Date)}, ".mod(new Date)");
    assertException(function () {new Big('12.345').mod(new RegExp)}, ".mod(new RegExp)");
    assertException(function () {new Big('12.345').mod(function () {})}, ".mod(function () {})");
    assertException(function () {new Big('12.345').mod(' 0.1')}, ".mod(' 0.1')");
    assertException(function () {new Big('12.345').mod('7.5 ')}, ".mod('7.5 ')");
    assertException(function () {Big('12.345').mod(' 0 ')}, ".mod(' 0 ')");
    assertException(function () {new Big('12.345').mod('+1')}, ".mod('+1')");
    assertException(function () {new Big('12.345').mod(' +1.2')}, ".mod(' +1.2')");
    ...
    assertException(function () {new Big('12.345').mod('4e1.')}, ".mod('4e1.')");
    assertException(function () {Big('12.345').mod(Infinity)}, ".mod(Infinity)");
    assertException(function () {new Big('12.345').mod('-Infinity')}, ".mod('-Infinity')");
